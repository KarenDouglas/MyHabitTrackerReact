...
const  submitHabitHandler= (e) => {
        e.preventDefault();
        setHabits([...habits, {text: habitInputText, completed: false, id: Math.random()*1000 }]);
        setHabitInputText("");
};
    ...
    return (  
        ...
        <form className="habit-form">
          ...
          <button onClick={submitHabitHandler} className= "habit-button" type="submit"><i className="fa fa-plus-circle fa-lg"/></button>
        </form>
        </React.Fragment>
    );
}
